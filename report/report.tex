...
Because the processes being performed by the program can be broken down so easily means performing a bit of decomposition during design will be very helpful and easy to do.
...
\item Calculate average size of a PNG at the input resolution, using ().
